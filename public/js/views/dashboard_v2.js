window.DashboardView = {
    ...
    render: function() {
        ...
        <div class="grid grid-cols-12 gap-gutter">
            ...
            <div class="col-span-12 md:col-span-6 lg:col-span-3 bg-surface-container-lowest p-md rounded-xl shadow-sm border border-surface-border relative">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="font-body-sm text-[12px] text-text-muted">Total SKS lulus (ganjil)</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-span-12 md:col-span-6 lg:col-span-3 bg-surface-container-lowest p-md rounded-xl shadow-sm border border-surface-border relative">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="font-body-sm text-[12px] text-text-muted">Total SKS lulus (genap)</p>
                    </div>
                </div>
            </div>
            ...
            <div onclick="window.app.navigate('semester')" class="col-span-12 md:col-span-6 lg:col-span-6 bg-surface-container-lowest p-md rounded-xl shadow-sm border border-surface-border flex flex-col justify-between cursor-pointer hover:border-primary/50 hover:shadow-md transition-all group">
